...
const PAGE_PATH = "/christmas-drone-shows";
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "Christmas Drone Shows",
        item: PAGE_URL,
      },
    ],
  };

  // Optional FAQ schema (recommended)
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "@id": `${PAGE_URL}#faq`,
    mainEntity: [
      {
        "@type": "Question",
        name: "What can you show in a Christmas drone light show?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "We can animate holiday icons like trees, ornaments, snowflakes, candy canes, gifts, stylized Santa scenes, plus custom venue names, sponsor logos, and holiday messages.",
        },
      },
      {
        "@type": "Question",
        name: "Are Christmas drone shows a safe alternative to fireworks?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. Drone light shows are a venue-safe, family-friendly alternative with no smoke or fallout. We operate FAA Part 107 and coordinate planning and safety protocols for your location.",
        },
      },
      {
        "@type": "Question",
        name: "How far in advance should we book a holiday drone show in Las Vegas?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Holiday dates book early. For best availability and time for custom design approvals, we recommend reserving as soon as your venue and timeline are confirmed.",
        },
      },
    ],
  };
