...
export default function ChatbotClient() {
  ...
  const [threadId, setThreadId] = useState<string | null>(null); // remembers the conversation

  const wrapperRef = useRef<HTMLDivElement>(null);

  // Fade-in + theme from localStorage / system
  useEffect(() => {
    setIsVisible(true);
  ...
  // Persist theme + set data-theme on <html>
  useEffect(() => {
  ...
  const handleSubmit = async (
    ...
    const historyForRequest = [...chatHistory, userMsg];
    ...
    try {
      ...
      while (true) {
        ...
        // Update the last assistant message as streaming comes in
        setChatHistory((prev) => {
