...
const PAGE_PATH = "/corporate-events";
...
export default function CorporateEventsPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can you display our logo or messaging during a corporate event?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. We create custom formations and animations including logos, icons, sponsor marks, short messaging, dates, and multi-scene sequences tailored to your event.",
        },
      },
      {
        "@type": "Question",
        name: "Do you handle planning, venue coordination, and FAA compliance?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. We handle planning, safety protocols, airspace coordination, and venue logistics as part of production so your show runs smoothly and safely.",
        },
      },
    ],
  };
  ...
  return (
    <main className="min-h-screen bg-black text-white pt-32 pb-16 px-6 font-poppins">
      {/* ✅ Breadcrumb Schema */}
      <Script
        id="ld-breadcrumbs-corporate-events"
